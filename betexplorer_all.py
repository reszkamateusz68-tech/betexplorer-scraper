...
BB_TEMPLATES = [
    ...
    {"name": "Standard", "code": "U4.5+HT_U3.5+2H_U4.5+HU3.5+AU3.5", "base_odd": 1.60, "min_prob": 0.65}
]
...
for idx, row in fixtures_clean.iterrows():
    ...
    def add_pred_local(engine, typ, szansa, kurs_szac, arg):
        ...
        elif prob_decimal >= 0.95 and kurs_docelowy >= 1.15: risk_tag = "🥈 SILVER PICK"
        elif prob_decimal >= 0.95 and kurs_docelowy >= 1.10: risk_tag = "🥉 BRONZE PICK"
    ...
    if len(h_tot_all) >= 10 and len(a_tot_all) >= 10 and len(h_dom) >= 5 and len(a_wyj) >= 5:
        ...
        if prob_1_5 >= 0.90:
            est_odd = round(1.0 + (((1/prob_1_5) - 1.0) / 1.5), 2)
...
print("Wdrożono całkowite usuwanie śmieciowych typów, precyzyjne H2H oraz nowy system medali.")
print("=" * 60)
